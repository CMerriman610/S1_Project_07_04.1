...
function verifyCrops() {
    // Code provided in repo, supposed to be broken
    try {
        for (var i = 0; i < 7; i++) {
        ...
        // Removes any former recommendation heading
...
//    testFormCompleteness();
    ...
    try {
        ...
        validity = false;
        messageText = message;
        monthsBox.value = ''; //Remove any former recommendation heading
    }
    finally {
...
function createRecommendation() {
    if (acresBox.value <= 5000) { // 5000 acres or less, no crop test needed
        // YEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEET
